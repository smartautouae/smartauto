...
import {
  ...
  Car, Wind, Lightbulb, Layers, Palette, Thermometer, Sun, Zap,
} from "lucide-react";
...
const colourPpfVsWrap = [
  ...
  },
  {
    ...
    ppf: "Yes - 100+ colour options available",
    wrap: "Yes - 100+ colour options available",
  },
  {
    aspect: "Thickness",
  ...
  {
    aspect: "Durability",
    ppf: "5–10 years with proper care",
    wrap: "3–7 years",
  },
  {
...
const process = [
  {
    num: "01",
    title: "Consultation",
    desc: "Choose your colour, finish, and scope - full body, partial panels, or accents. We help you select from 100+ colour PPF options and advise on the best coverage for your car and budget.",
  },
  {
    num: "02",
...
const faqs = [
  ...
  },
  {
    ...
    a: "A professionally installed colour PPF using premium film typically lasts 5–10 years under UAE conditions. Our colour PPF films are UV-stabilised and engineered to resist yellowing, chemical etching, and degradation in extreme heat and sun - making them ideal for Dubai and Sharjah's climate.",
  },
  {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                <div className="inline-flex items-center gap-2.5 border rounded-full px-4 py-1.5 mb-8 text-[10px] tracking-[0.3em] uppercase"
                  ...
                  100+ Colours · Self-Healing · Stone Chip Protection · Removable
                </div>
                ...
                <p className="mb-8 leading-[1.9]"
                  ...
                  <strong style={{ color: "rgba(255,255,255,0.8)", fontWeight: 600 }}>100+ colour options</strong>.
                </p>
                    ...
                    <div className="flex items-center gap-3 rounded-2xl px-5 py-4 border backdrop-blur-md"
                      ...
                      <div>
                        ...
                        <div className="text-[11px] mt-0.5" style={{ color: "rgba(255,255,255,0.4)" }}>
                          100+ Colours · Gloss · Matte · Satin · Metallic
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    <p className="text-[14px] leading-[1.9] mb-4" style={{ color: "rgba(255,255,255,0.5)" }}>
                      ...
                      removes swirl marks with heat, and is rated to last{" "}
                      <strong style={{ color: "rgba(255,255,255,0.8)" }}>5–10 years</strong> in UAE conditions.
                    </p>
                    <p className="text-[14px] leading-[1.9]" style={{ color: "rgba(255,255,255,0.5)" }}>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="max-w-2xl mx-auto text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.4)" }}>
                With 100+ colour PPF options available - gloss, matte, satin, metallic, satin chrome, and
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <div className="flex flex-col gap-4 mb-9">
                  {[
                    { icon: Palette,     text: "100+ colour options - gloss, matte, satin, metallic, chrome, custom" },
                    { icon: ShieldCheck, text: "Self-healing PPF - stone chip & scratch resistant, 5–10 yr lifespan" },
                    { icon: MapPin,      text: "4 branches - MotorCity, Al Quoz, Mirdif & Sharjah" },
                    { icon: Clock,       text: "Open every day 10AM – 10PM - walk-ins & bookings welcome" },
                  ].map((item) => (
            ...
            <div className="relative rounded-3xl overflow-hidden border px-10 py-16 md:px-20 text-center"
              ...
              <div className="relative z-10">
                ...
                <p className="mb-8 max-w-lg mx-auto text-sm leading-[1.9]"
                  ...
                  100+ colour options · Gloss · Matte · Satin · Metallic · Custom.
                  Self-healing · Stone chip protection · 5–10 year lifespan.
